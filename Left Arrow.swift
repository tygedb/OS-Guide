...
class Left_Arrow: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let gradient2 = CGGradient(colorsSpace: CGColorSpaceCreateDeviceRGB(), colors: [gradient2Color.cgColor] as CFArray, locations: [0])!
        
        //// Rectangle 2 Drawing
        context!.saveGState()
        context!.translateBy(x: 11.13, y: 20.15)
        ...
        //// Bezier 2 Drawing
        context!.saveGState()
        context!.translateBy(x: 18.13, y: 1.98)
        context!.rotate(by: 85.66 * CGFloat(M_PI) / 180)
