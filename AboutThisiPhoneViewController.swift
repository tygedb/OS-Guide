//
//  AboutThisiPhoneViewController.swift
//  OS Guide
//
...
class AboutThisiPhoneViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        titleLabel.text = "About \(modelName2)"
        label1.text = "Multitasking Supported: \(multitasking)"
        label2.text = "Battery Monitoring: \(batterymon)"
        label3.text = "Battery State: \(bS)"
        label4.text = "Orientation: \(bs)"
